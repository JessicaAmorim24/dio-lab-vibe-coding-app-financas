# 💸 App de Finanças Pessoais da Jéssica com Vibe Coding

PRD refinado no ChatGPT:

```markdown:
# PRD (Product Requirements Document) – Aplicativo de Organização de Finanças Pessoais Conversacional

## 1. Visão Geral do Produto
O produto é um aplicativo de Organização de Finanças Pessoais baseado em conversação, que permite ao usuário registrar, acompanhar e analisar seus gastos por meio de linguagem natural, reduzindo atritos comuns em aplicativos financeiros tradicionais.

A solução adota princípios de Design Universal, garantindo acessibilidade, simplicidade e clareza para usuários com diferentes níveis de familiaridade tecnológica, limitações cognitivas, motoras ou visuais.

O foco é tornar o controle financeiro uma atividade contínua, natural e sustentável, evitando formulários extensos e planilhas complexas.

---

## 2. Problema a Ser Resolvido
Aplicativos de finanças pessoais apresentam alta taxa de abandono devido a:
- Excesso de entrada manual de dados
- Fluxos rígidos e pouco personalizados
- Interfaces complexas para usuários iniciantes

Esses fatores geram frustração e impedem a criação de hábitos financeiros consistentes.
O produto busca resolver esse problema oferecendo uma experiência baseada em conversa e recomendações automáticas de economia.

---

## 3. Objetivos do Produto
- Simplificar o registro e acompanhamento financeiro
- Incentivar a constância no controle de gastos
- Tornar a análise financeira compreensível para iniciantes
- Oferecer orientação prática por meio de um agente conversacional

---

## 4. Público-Alvo
- Pessoas iniciantes no controle financeiro
- Usuários que desejam praticidade e rapidez
- Pessoas que se sentem intimidadas por planilhas e sistemas financeiros tradicionais
...
O aplicativo transforma registros financeiros em diálogos naturais, com categorização automática, acompanhamento de metas e recomendações personalizadas.
...
- Registrar gastos via chat em linguagem natural  
  Exemplo: "Gastei 60 reais no almoço hoje"
- Confirmação automática ou assistida dos dados interpretados

### 6.2 Classificação Automática
- Classificação automática das transações por categoria
- Possibilidade de correção pelo usuário, com aprendizado progressivo do sistema

### 6.3 Metas Financeiras
- Definição de metas simples (ex.: economizar X por mês)
- Acompanhamento do progresso de forma visual e objetiva

### 6.4 Agente Financeiro
- Agente conversacional responsável por:
  - Oferecer dicas de economia
  - Alertar sobre padrões de gasto
  - Incentivar o cumprimento de metas

### 6.5 Relatórios
- Tela de Relatórios simples e personalizada
- Visualização de:
...
1. Tela de Chat (Home)
   - Principal ponto de interação do usuário com o sistema
...
- Interface com baixo esforço cognitivo
- Feedback constante ao usuário
- Compatibilidade com leitores de tela

---

## 9. Critérios de Sucesso (Validação Inicial)
- Usuário consegue registrar um gasto sem ajuda externa e instruções prévias
- Usuário entende seus gastos mensais em menos de 2 minutos
- Usuário retorna ao app ao menos 3 vezes na primeira semana

---

## 10. Entregável da IA
A IA deverá:
- Propor um plano de MVP
- Listar as principais telas e fluxos
- Indicar recursos mínimos necessários
- Sugerir hipóteses e formas de validação inicial
